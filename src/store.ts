...
export const defaults:Controls={world:'Living Vault',journey:true,energy:.5,motion:.35,detail:.7,glow:.35,reactivity:.9,imageMix:.7,seed:7319,palette:'Iridescent',quality:'Balanced',aspect:'Fit',playing:true,orbit:true};
